...
$sql = "INSERT INTO `tbl_admin`(`admin_name`, `admin_mobile`, `admin_password`, `admin_status`, `admin_type`, `admin_forane`) VALUES ('$fullname','$usermobile','$password','2','3','$forane')";
if($password == $cpass){
...
<script>
  ...
  <div class="login" style="margin-top:-100px;">
    <form action="#" method="POST" name="formValidation" id="formValidation"  enctype="multipart/form-data">
      ...
      <input type="text" style="color: black;" placeholder="Location" name="location" id="location" pattern="[A-Za-z]" required><br>
...
<?php
   ...
   <select id="forane" name="forane" style="color:black;">
       ...
       if($result->num_rows>0){
           ...
           echo '<option value="">Forane not available<option>';
       }
       ?>
   </select>
<br><br>
