                            ...
                            <form method="POST" action="" class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" readonly name="name" value="<?=$rowUsers['name'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="place" class="col-sm-3 text-right control-label col-form-label">Executive 1</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" readonly name="exc1_name" id="lname" value="<?=$rowUsers['exc1_name'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="place" class="col-sm-3 text-right control-label col-form-label">Location</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" readonly name="exc1_location" id="lname" value="<?=$rowUsers['exc1_location'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="phone" class="col-sm-3 text-right control-label col-form-label">Contact No</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" readonly name="exc1_contact" value="<?=$rowUsers['exc1_contact'];?>" id="phone" ">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="place" class="col-sm-3 text-right control-label col-form-label">Executive 2</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" readonly name="exc2_name" id="lname" value="<?=$rowUsers['exc2_name'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="place" class="col-sm-3 text-right control-label col-form-label">Location</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" readonly name="exc2_location" id="lname" value="<?=$rowUsers['exc2_location'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="phone" class="col-sm-3 text-right control-label col-form-label">Contact No</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" readonly name="exc2_contant" value="<?=$rowUsers['exc2_contant'];?>" id="phone" ">
                                        </div>
                                    </div>
                                </div>
