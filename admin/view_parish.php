            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <?php
                            ...
                            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="./Addeventsforane.php" aria-expanded="false"><i class="mdi mdi-relative-scale"></i><span class="hide-menu">Add Events</span></a></li>
                            </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              ...
                              <?php $id=$_GET['id']; ?>
                                <button class="btn btn-primary" onclick="window.location.href='createparish.php?id=<?php echo $id ?>'" type="submit">Create</button><br><br>
                            </div>
                            <table class="table">
                                <thead>
                                  <tr>
                                  <th scope="col">Forane</th>
                                    <th scope="col">Parish</th>
                                    <th scope="col">Priest Name</th>
                                    <th scope="col">Youth Members</th>
                                ...
                                <tbody>
                                  ...
                                  $res=mysqli_query($con, "select * from tbl_parish where parish_status='1' and forane_id='$id'");
                                  while($row=mysqli_fetch_array($res))
                                  {
                                    ...
                                    <td><?php echo $row['youth_members']; ?></td>
                                    <td><a href="edit_parish.php?id=<?php echo $row["parish_id"]; ?>"><i class="fas fa-edit"></a></td>
                                    <td><a href="delete_parish.php?id=<?php echo $row["parish_id"]; ?>"><i class="fas fa-trash"></a></td>
