                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            <?php
                                ...
                                $id=$_GET['id'];
                                $res="select * from tbl_parish WHERE parish_id='$id'";
                                $res_run=mysqli_query($con,$res);

                                if(mysqli_num_rows($res_run) > 0)
                                {
                                    foreach($res_run as $user){
                        ...
                        <form method="POST" action = "" class="form-horizontal">
                                <div class="card-body">
                                    <h4 class="card-title">Edit Parish Details</h4>
                                    <div class="form-group row">
                                    <label for="name" class="col-sm-3 text-right control-label col-form-label">Forane Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="forane" value="<?=$user['forane'];?>">
                                        </div><br><br>
                                        
                                        <label for="name" class="col-sm-3 text-right control-label col-form-label">Parish Name</label>
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" name="name" value="<?=$user['parish_name'];?>">
                                    </div>

                                    <label for="name" class="col-sm-3 text-right control-label col-form-label">Priest Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="priest_name" value="<?=$user['priest_name'];?>">
                                        </div><br><br>
                                        <label for="name" class="col-sm-3 text-right control-label col-form-label">Youth Members</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="youth_members" value="<?=$user['youth_members'];?>">
                                        </div><br><br>
                                        <input type="hidden" value="<?=$user['parish_id'];?>">
                                        </div>
                                    </div>
                            ...
                            <?php
                             if(isset($_POST['submit']))
                             {
                                $forane = $_POST['forane'];
                                 ...
                                 $sql="UPDATE tbl_parish SET forane='$forane',parish_name='$name',priest_name='$priest_name',youth_members='$youth_members' WHERE parish_id = '$id'";
                                 $q = mysqli_query($con,$sql);
                                 if($q)
                                 {
                                     header("Location: view_parish2.php");
                                 }
