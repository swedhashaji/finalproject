                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <?php
                            ...
                            $forane_id=$_GET['id'];
                            $query="SELECT * from forane WHERE forane_id='$forane_id'";
                            ...
                            <form method="POST" action="" class="form-horizontal">
                                <div class="card-body">
                                    <h4 class="card-title">Edit Forane Details</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="exc1_name" id="lname" value="<?=$user['exc1_name'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="place" class="col-sm-3 text-right control-label col-form-label">Location</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="exc1_location" id="lname" value="<?=$user['exc1_location'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="phone" class="col-sm-3 text-right control-label col-form-label">Contact No</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="exc1_contact" value="<?=$user['exc1_contact'];?>" id="phone" ">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="place" class="col-sm-3 text-right control-label col-form-label">Executive 2</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="exc2_name" id="lname" value="<?=$user['exc2_name'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="place" class="col-sm-3 text-right control-label col-form-label">Location</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="exc2_location" id="lname" value="<?=$user['exc2_location'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="phone" class="col-sm-3 text-right control-label col-form-label">Contact No</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="exc2_contant" value="<?=$user['exc2_contant'];?>" id="phone" ">
                                        </div>
                                    </div>
                                </div>
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                $sql="UPDATE forane SET name='$name', exc1_name = '$exc1_name', exc1_location = '$exc1_location', exc1_contact = '$exc1_contact',exc2_name = '$exc2_name', exc2_location = '$exc2_location', exc2_contant = '$exc2_contant' WHERE forane_id = '$forane_id'";
