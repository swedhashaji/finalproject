...
$str = "SELECT usermobile from registration WHERE usermobile='$usermobile'";
...
$sql = "INSERT INTO  registration (usermobile, fullname,password,forane,parish, bgroup,donate,image)
VALUES ('$usermobile', '$fullname', '$password','$forane','$parish','$bgroup','$donate','$targetFilePath')";
...
<script>
  ...
  <div class="login" style="margin-top:-100px;">
    <form action="#" method="POST" name="formValidation" id="formValidation"  enctype="multipart/form-data">
      ...
      <input type="password" style="color: black;" placeholder="confrim password" name="cpassword" id="cpassword" pattern="^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=\S+$).{6,}$" required><br><br>
...
?>
<select name='blood' style="color: black;">
  <?php
...
<select name='donate' style="color: black;">
...
<br>
      ...
      Already a Member?<a style="color:white;" href="userlogin.php"> Login Here. </a></h5>
      </form>
  </div>
